    ...
    public partial class InitialCleaned : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkTemplate", x => new { x.TeacherId, x.Topic });
                    table.ForeignKey(
                        name: "FK_HomeworkTemplate_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentLessons", x => new { x.StudentId, x._lessonsId });
                    table.ForeignKey(
                        name: "FK_StudentLessons_Lessons__lessonsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkSubmissions", x => new { x.StudentId, x.HomeworkId });
                    table.ForeignKey(
